...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PetsApi()
        api_instance.create_pets  # this is an instance of the class Endpoint
        api_instance.create_pets()  # this invokes api_instance.create_pets.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_pets.callable or self.callable in this class
